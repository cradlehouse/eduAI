...
| `DATABASE_URL` (Supavisor pooled, 6543) | Render | orchestrator. Must be the **pooler** host (`postgres.<ref>@aws-0-us-west-2.pooler.supabase.com:6543`): the direct `db.<ref>` host is IPv6-only and Render has no IPv6. Percent-encode the password |
