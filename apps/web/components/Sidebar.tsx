...
export function Sidebar({ budget, children }: { budget?: Budget | null; children: React.ReactNode }) {
  return (
    <aside className="panel m-3 flex w-[68px] shrink-0 flex-col p-3 lg:w-64">
      {budget && (
        <>
